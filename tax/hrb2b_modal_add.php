  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!--
           ...
           -->
      <form class="form-horizontal" enctype="multipart/form-data" name="hrb2b_form" id="hrb2b_form" action="./tax/import_hrb2b.php" method="POST">
...
<div class="modal fade" id="ReModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" enctype="multipart/form-data" name="reno_hrb2b" id="reno_hrb2b" action="./tax/reno_hrb2b.php" method="POST">
        <div class="modal-body">
          <div class="messages"></div>
