    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <?php echo substr($title,13,strlen($title)-13) .'-CSV上傳';?>
                </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form class="form-horizontal" enctype="multipart/form-data" name="grb2c_form" id="grb2c_form" action="./tax/import_grb2c.php" method="POST">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="reno_grb2c" id="reno_grb2c" action="./tax/reno_grb2c.php" method="POST">
                <div class="modal-body">
                    <div class="messages"></div>
