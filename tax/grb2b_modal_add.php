<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="grb2b_form" id="grb2b_form" action="./tax/import_grb2b.php" method="POST">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="reno_grb2b" id="reno_grb2b" action="./tax/reno_grb2b.php" method="POST">
                <div class="modal-body">
                    <div class="messages"></div>
