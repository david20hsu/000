...
if (isset($_POST['submit'])) {
    ...
    if ($comp_idno != '' && $yy != '' && $month != '') {
        $sql = "select a.*,b.api_idno,api_sign from tax_b2b a left join comp b on a.uncode=b.comp_idno where a.datetime like '$ym' and a.tp='1' and a.tax_status='0' and  (a.tax_id='' or a.tax_id is null)";
        $msg = Rebud_json($sql);
    } else {
