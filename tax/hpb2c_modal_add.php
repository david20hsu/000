...
<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="hpb2c_form" id="hpb2c_form" action="./tax/import_hpb2c.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">   
                            <input type="hidden" name="MAX_FILE_SIZE" value="10000000" /><input type="file" name="csv_file" id="csv_file"   accept=".csv" required value=""/>      
                            <!--
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="reno_hpb2c" id="reno_hpb2c" action="./tax/reno_hpb2c.php" method="POST">
                <div class="modal-body">
                    <div class="messages"></div>
